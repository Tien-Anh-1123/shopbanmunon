 ...
 */
    ...
    $vnp_Returnurl = "https://munonchat.azurewebsites.net/vnpay_php/vnpay_return.php";
    ...
    <div class="container" style="margin-top: 50px;background-color: #f6f7fb;border-radius: 10px;">
        ...
        <a href="index.php"><button style="margin-bottom: 30px;background-color: #00ab90;" class="btn btn-success">QUAY
                LẠI</button></a>
    </div>
