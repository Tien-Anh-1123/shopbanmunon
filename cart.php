                        ...
                        if (isset($_SESSION['cart'])) {
                            foreach ($_SESSION['cart'] as $id => $value) {
                                ...
                                echo '<tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
                                            <div class="input-group-btn">
                                                <a href="./update_cart.php?id=' . $id . '&type=giam" class="btn btn-sm btn-primary btn-minus" >
                                            ...
                                            <div class="input-group-btn">
                                                <a href="./update_cart.php?id=' . $id . '&type=tang" class="btn btn-sm btn-primary btn-plus">
                                    ...
                                    <td class="align-middle"><a href="./delete_cart.php?id=' . $id . '" class="btn btn-sm btn-primary"><i class="fa fa-times"></i></a></td>
                                </tr>';
                            }
                        } else {
